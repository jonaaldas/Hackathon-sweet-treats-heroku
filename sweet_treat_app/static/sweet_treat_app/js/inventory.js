...
function ready() {
  ...
  for (let i = 0; i < inStock.length; i++) {
    ...
    if (available.innerText === "Unavailable") {
      ...
      available.classList.add("out-of-stock");
...
const announcementBannerEl = document.getElementsByClassName(
  "announcement-banner"
);

document
  .getElementById("announcement-btn")
  .addEventListener("click", function () {
    announcementBannerEl[0].style.display = "none";
  });

/////////////////////////////////////////////////////////////////////////////////////
// Hamburger Menu
/////////////////////////////////////////////////////////////////////////////////////
const navigationMenuEl = document.getElementsByClassName("navigation-menu");
const hamburgerMenuEl = document.getElementById("hamburger-menu");

console.log(navigationMenuEl);

document;
hamburgerMenuEl.addEventListener("change", function () {
  if (this.checked) {
    navigationMenuEl[0].style.display = "block";
  } else {
    navigationMenuEl[0].style.display = "none";
  }
});
